...
const Analytics:React.FC = () => {
    ...
    const userRecords: UserRecord[] = [
        { id: 1, user_email_id: 1, title: 'Record 1', description: 'Description 1', tags: ['tag1', 'tag2'], media: null },
        { id: 2, user_email_id: 2, title: 'Record 2', description: 'Description 2', tags: ['tag1'], media: null },
        { id: 3, user_email_id: 1, title: 'Record 3', description: 'Description 3', tags: ['tag2', 'tag3'], media: null },
